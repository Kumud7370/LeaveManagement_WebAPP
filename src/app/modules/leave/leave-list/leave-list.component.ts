...
import {
  ...
  ModuleRegistry,
  AllCommunityModule,
  themeQuartz          // ← NEW THEMING API (v32+)
} from 'ag-grid-community';
import Swal from 'sweetalert2';
import { LeaveService } from '../../../core/services/api/leave.api';
import { LeaveTypeService } from '../../../core/services/api/leave-type.api';
...
// ── AG Grid v32+ Theming API ─────────────────────────────────────────────
// This is the ONLY reliable way to get column separator lines in v32+.
// CSS variables and ::after pseudo-elements are ignored by the new renderer.
