...
export class BtnPdfCellRenderer implements ICellRendererAngularComp {
  ...
  onClick(): void {
    console.log("PDF button clicked", this.params.data)
    // Call the parent component method to fetch transaction details and generate PDF
    this.params.context.componentParent.downloadLogsheetPDF(this.params.data)
  }
}
